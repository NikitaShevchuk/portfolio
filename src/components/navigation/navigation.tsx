...
const Navigation = () => {
  ...
  const nextScreen = () => dispatchScreenState(screenActions.nextScreen());
  return (
    <>
      <div className='navigation'>
        ...
        <div className='navigation__scrolldown link' onClick={nextScreen}>
          <div className='navigation__scrolldown-text'>scroll</div>
          <div className='navigation__scrolldown-line'></div>
        </div>
      </div>
      <div className='navigation__count'>
        <div className='navigation__line main' onClick={() => changeScreen(1)}></div>
        <div className='navigation__line about' onClick={() => changeScreen(2)}></div>
        <div className='navigation__line works' onClick={() => changeScreen(3)}></div>
        <div className='navigation__line contacts' onClick={() => changeScreen(4)}></div>
      </div>
    </>
  );
};
