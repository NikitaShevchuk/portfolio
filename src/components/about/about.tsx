      ...
      <div className="page-content__main">
        ...
        <div className="page-content__section">
          ...
          <div className="page-content__main-text">
            ...
            Redux, and Typescript. Can easily communicate in English during a
            workflow. My passion is building dynamic, content-aware
            client-facing systems for online retail, business services, and
            other areas with a modern tech stack.
          </div>
        </div>
